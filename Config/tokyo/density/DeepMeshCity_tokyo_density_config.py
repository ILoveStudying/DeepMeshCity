...
EndDate = '20170709'
CITY = 'tokyo'
DataPath = './Data/tokyo/density/'
DataFile = DataPath + 'density_tokyo_{}_{}_30min.npy'.format(StartDate, EndDate)
...
dataset_cfg = dict(
    ...
    DateEnd=EndDate,
    freq='30min',
    train_data_paths=DataPath + 'train_tokyo_density.npz',
    valid_data_paths=DataPath + 'valid_tokyo_density.npz',
    test_data_paths=DataPath + 'test_tokyo_density.npz',
)
...
train_cfg = dict(
    ...
    check_point_file='checkpoint/tokyo/density/DeepMeshCity.pth',
    gen_frm_dir='Results/tokyo/density/DeepMeshCity'
)
