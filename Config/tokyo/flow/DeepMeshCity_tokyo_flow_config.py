...
EndDate = '20170709'
CITY = 'tokyo'
DataPath = './Data/tokyo/flow/'
DataFile = DataPath + 'flowio_tokyo_{}_{}_30min.npy'.format(StartDate, EndDate)
...
dataset_cfg = dict(
    ...
    DateEnd=EndDate,
    freq='30min',
    train_data_paths=DataPath + 'train_tokyo_flow.npz',
    valid_data_paths=DataPath + 'valid_tokyo_flow.npz',
    test_data_paths=DataPath + 'test_tokyo_flow.npz',
)
...
train_cfg = dict(
    ...
    check_point_file='checkpoint/tokyo/flow/DeepMeshCity.pth',
    gen_frm_dir='Results/tokyo/flow/DeepMeshCity'
)
