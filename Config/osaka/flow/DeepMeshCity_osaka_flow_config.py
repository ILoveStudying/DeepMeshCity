...
EndDate = '20170709'
CITY = 'osaka'
DataPath = './Data/osaka/flow/'
DataFile = DataPath + 'flowio_osaka_{}_{}_30min.npy'.format(StartDate, EndDate)
...
dataset_cfg = dict(
    ...
    DateEnd=EndDate,
    freq='30min',
    train_data_paths=DataPath + 'train_osaka_flow.npz',
    valid_data_paths=DataPath + 'valid_osaka_flow.npz',
    test_data_paths=DataPath + 'test_osaka_flow.npz',
)
...
train_cfg = dict(
    ...
    check_point_file='checkpoint/osaka/flow/DeepMeshCity.pth',
    gen_frm_dir='Results/osaka/flow/DeepMeshCity'
)
